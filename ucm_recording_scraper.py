...
MAX_RECORDINGS_PER_ITERATION = 10  # Limit recordings to prevent overwhelming UCM (10 files × 15s delay = ~2.5 min)
DOWNLOAD_TIMEOUT_MS = 90000  # 90 seconds timeout for downloads (UCM can be slow)
RATE_LIMIT_DELAY_SECONDS = 15  # UCM requires 15 second delay between downloads to prevent rate limiting
