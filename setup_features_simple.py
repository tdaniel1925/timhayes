...
# -*- coding: utf-8 -*-
"""
AI Features Setup Script (Windows Compatible)
"""
...
# Get database URL - Force PostgreSQL for setup
...
FEATURES_DATA = [
    {
        ...
        'use_cases': json.dumps(['Customer support call logs', 'Sales conversation notes', 'Manager review preparation']),
        'roi_metrics': json.dumps({'time_saved_per_call': '3-5 minutes', 'accuracy_improvement': '95%', 'cost_per_call': '$0.05'}),
        'is_active': True,
        'is_beta': False,
    ...
    },
    {
        ...
        'use_cases': json.dumps(['Agent performance reviews', 'Training needs identification', 'Quality assurance automation']),
        'roi_metrics': json.dumps({'performance_improvement': '40%', 'qa_time_saved': '10 hours/week', 'consistency_increase': '85%'}),
        'is_active': True,
        'is_beta': False,
        'requires_approval': False,
        'display_order': 2
    },
    {
        ...
        'use_cases': json.dumps(['Sales follow-up tracking', 'Support ticket creation', 'Project management']),
        'roi_metrics': json.dumps({'followup_completion': '95%', 'deals_saved': '12%', 'customer_satisfaction': '+25 NPS'}),
        'is_active': True,
        'is_beta': False,
        'requires_approval': False,
        'display_order': 3
    },
    {
        ...
        'use_cases': json.dumps(['Product feedback analysis', 'Feature request tracking', 'Pain point identification']),
        'roi_metrics': json.dumps({'trend_discovery_speed': '10x faster', 'pattern_accuracy': '92%', 'product_feedback_captured': '100%'}),
        'is_active': True,
        'is_beta': False,
        'requires_approval': False,
        'display_order': 4
    },
    {
        ...
        'use_cases': json.dumps(['TCPA compliance (Do Not Call)', 'HIPAA compliance (healthcare)', 'Financial services regulations']),
        'roi_metrics': json.dumps({'violation_detection': '99.8%', 'fine_prevention': '$500K+/year', 'audit_time_saved': '40 hours/month'}),
        'is_active': True,
        'is_beta': False,
    ...
    },
    {
        ...
        'use_cases': json.dumps(['Customer satisfaction tracking', 'Escalation prevention', 'Agent performance monitoring']),
        'roi_metrics': json.dumps({'churn_reduction': '18%', 'early_warning_accuracy': '87%', 'retention_improvement': '$120K/year'}),
        'is_active': True,
        'is_beta': False,
        'requires_approval': False,
        'display_order': 6
    },
    {
        ...
        'use_cases': json.dumps(['De-escalation triggers', 'Empathy coaching', 'Customer experience mapping']),
        'roi_metrics': json.dumps({'emotion_accuracy': '91%', 'escalation_reduction': '35%', 'customer_satisfaction': '+18 CSAT'}),
        'is_active': True,
        'is_beta': False,
        'requires_approval': False,
        'display_order': 7
    },
    {
        ...
        'use_cases': json.dumps(['Proactive retention campaigns', 'Customer success prioritization', 'Revenue protection']),
        'roi_metrics': json.dumps({'churn_reduction': '30%', 'prediction_accuracy': '84%', 'revenue_saved': '$250K+/year'}),
        'is_active': True,
        'is_beta': True,
        'requires_approval': False,
        'display_order': 8
    },
    {
        ...
        'use_cases': json.dumps(['Call routing optimization', 'Lead qualification', 'Support vs sales classification']),
        'roi_metrics': json.dumps({'routing_accuracy': '96%', 'time_to_resolution': '-45%', 'conversion_rate': '+22%'}),
        'is_active': True,
        'is_beta': False,
        'requires_approval': False,
        'display_order': 9
    },
    {
        ...
        'use_cases': json.dumps(['Sales pipeline accuracy', 'Deal coaching', 'Forecast improvement']),
        'roi_metrics': json.dumps({'win_rate_increase': '28%', 'forecast_accuracy': '93%', 'deal_velocity': '+15 days faster'}),
        'is_active': True,
        'is_beta': True,
        'requires_approval': False,
        'display_order': 10
    },
    {
        ...
        'use_cases': json.dumps(['Sales training', 'Objection playbook creation', 'Competitive intelligence']),
        'roi_metrics': json.dumps({'objection_handling': '+45% effectiveness', 'close_rate': '+19%', 'training_time': '-60%'}),
        'is_active': True,
        'is_beta': False,
        'requires_approval': False,
        'display_order': 11
    },
    {
        ...
        'use_cases': json.dumps(['Agent talk time optimization', 'Active listening coaching', 'Conversation balance']),
        'roi_metrics': json.dumps({'agent_effectiveness': '+32%', 'customer_engagement': '+28%', 'call_efficiency': '15% shorter calls'}),
        'is_active': True,
        'is_beta': False,
        'requires_approval': False,
        'display_order': 12
    },
    {
        ...
        'use_cases': json.dumps(['International customer support', 'Global sales teams', 'Compliance in multiple markets']),
        'roi_metrics': json.dumps({'language_coverage': '50+ languages', 'transcription_accuracy': '95%+', 'market_expansion': 'Unlimited'}),
        'is_active': True,
        'is_beta': False,
        'requires_approval': False,
        'display_order': 13
    },
    {
        ...
        'use_cases': json.dumps(['New agent onboarding', 'Complex product support', 'Compliance enforcement']),
        'roi_metrics': json.dumps({'ramp_time_reduction': '50%', 'first_call_resolution': '+35%', 'handle_time': '-20%'}),
        'is_active': True,
        'is_beta': True,
        'requires_approval': True,
        'display_order': 14
    },
    {
        ...
        'use_cases': json.dumps(['Dispute resolution', 'Quality assurance', 'Training materials']),
        'roi_metrics': json.dumps({'storage_reliability': '99.99%', 'retrieval_time': '<5 seconds', 'compliance_coverage': '100%'}),
        'is_active': True,
        'is_beta': False,
        'requires_approval': False,
        'display_order': 15
    },
    {
        ...
        'use_cases': json.dumps(['Competitor mentions', 'Product feedback', 'Compliance keywords']),
        'roi_metrics': json.dumps({'search_speed': '1000x faster', 'accuracy': '99%', 'competitive_intel': 'Real-time'}),
        'is_active': True,
        'is_beta': False,
        'requires_approval': False,
        'display_order': 16
    },
    {
        ...
        'use_cases': json.dumps(['Call routing analytics', 'Department performance', 'Product feedback tracking']),
        'roi_metrics': json.dumps({'tagging_accuracy': '94%', 'time_saved': '10 hours/week', 'reporting_improvement': '5x faster'}),
        'is_active': True,
        'is_beta': False,
        'requires_approval': False,
        'display_order': 17
    },
    {
        ...
        'use_cases': json.dumps(['Customer success planning', 'Upsell identification', 'Experience optimization']),
        'roi_metrics': json.dumps({'context_awareness': '100%', 'upsell_conversion': '+42%', 'customer_satisfaction': '+31 NPS'}),
        'is_active': True,
        'is_beta': True,
        'requires_approval': False,
        'display_order': 18
    },
    {
        ...
        'use_cases': json.dumps(['Salesforce integration', 'HubSpot sync', 'Custom CRM updates']),
        'roi_metrics': json.dumps({'time_saved': '2 hours/agent/day', 'crm_accuracy': '100%', 'adoption_increase': '+89%'}),
        'is_active': True,
        'is_beta': False,
        'requires_approval': True,
        'display_order': 19
    },
    {
        ...
        'use_cases': json.dumps(['Individual development plans', 'Performance improvement', 'Skill gap analysis']),
        'roi_metrics': json.dumps({'performance_improvement': '3x faster', 'coaching_efficiency': '+200%', 'retention': '+25%'}),
        'is_active': True,
        'is_beta': False,
        'requires_approval': False,
        'display_order': 20
    },
    {
        ...
        'use_cases': json.dumps(['Product feedback trends', 'Emerging issues', 'Market intelligence']),
        'roi_metrics': json.dumps({'trend_detection_speed': '4 weeks earlier', 'pattern_accuracy': '88%', 'proactive_fixes': '+150%'}),
        'is_active': True,
        'is_beta': False,
        'requires_approval': False,
        'display_order': 21
    },
    {
        ...
        'use_cases': json.dumps(['Win/loss analysis', 'Competitive positioning', 'Product roadmap input']),
        'roi_metrics': json.dumps({'win_rate_vs_competitors': '+35%', 'intel_coverage': '100%', 'response_time': '10x faster'}),
        'is_active': True,
        'is_beta': True,
        'requires_approval': False,
        'display_order': 22
    },
    {
        ...
        'use_cases': json.dumps(['Industry-specific compliance', 'Brand voice enforcement', 'Custom KPIs']),
        'roi_metrics': json.dumps({'customization': 'Unlimited criteria', 'consistency': '98%', 'brand_alignment': '+67%'}),
        'is_active': True,
        'is_beta': False,
        'requires_approval': True,
        'display_order': 23
    },
    {
        ...
        'use_cases': json.dumps(['Performance rankings', 'Best practice identification', 'Peer learning programs']),
        'roi_metrics': json.dumps({'performance_visibility': '100%', 'best_practice_adoption': '+73%', 'team_performance': '+41%'}),
        'is_active': True,
        'is_beta': False,
        'requires_approval': False,
        'display_order': 24
...
def create_super_admin(conn):
    ...
    # First, ensure managers table exists
    try:
        conn.execute(text("""
    ...
    result = conn.execute(text("SELECT id, email FROM managers WHERE email = 'superadmin@audia.com'"))
...
def seed_ai_features(conn):
    ...
    # First, ensure ai_features table exists
    try:
        conn.execute(text("""
    ...
    for feature_data in FEATURES_DATA:
        result = conn.execute(text("SELECT id FROM ai_features WHERE slug = :slug"), {"slug": feature_data['slug']})
        existing = result.fetchone()

        if existing:
            conn.execute(text("""
                UPDATE ai_features SET
                    name = :name, description = :description, long_description = :long_description,
                    category = :category, icon = :icon, monthly_price = :monthly_price,
                    setup_fee = :setup_fee, price_per_call = :price_per_call,
                    requires_openai = :requires_openai, openai_model = :openai_model,
                    processing_time_estimate = :processing_time_estimate,
                    benefit_summary = :benefit_summary, use_cases = :use_cases,
                    roi_metrics = :roi_metrics, is_active = :is_active,
                    is_beta = :is_beta, requires_approval = :requires_approval,
...
if __name__ == '__main__':
    try:
        ...
        print(f"AI Features: {total_features} features available")
        print("View at: https://timhayes-bo-production-58c5.up.railway.app/features\n")
        print("Next Steps:")
        print("  1. Login to super admin panel")
        print("  2. Enable AI features for test tenant")
        print("  3. Add OPENAI_API_KEY to Railway")
        print("  4. Test AI processing\n")
